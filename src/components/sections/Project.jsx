        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 justify-center">
          <div className="glass p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_4px_20px_rgba(59,130,246,0.1)] transition-all">
            ...
            <p className="text-gray-400 mb-4">
              Built a scalable movie search app using MERN stack, enabling users to effortlessly discover new films.
            </p>
          ...
          <div className="glass p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_4px_20px_rgba(59,130,246,0.1)] transition-all">
            ...
            <p className="text-gray-400 mb-4">
              Built a fully functional e-commerce website using MERN stack, providing seamless shopping experience.
            </p>
            <div className="flex flex-wrap gap-2 mb-4">
          ...
          <div className="glass p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_4px_20px_rgba(59,130,246,0.1)] transition-all">
            ...
            <p className="text-gray-400 mb-4">
              Designed and developed a personal portfolio website using HTML, CSS, and JavaScript to showcase skills and projects.
            </p>
            <div className="flex flex-wrap gap-2 mb-4">
